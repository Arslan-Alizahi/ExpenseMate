...
using ExpenseTracker.WebPortal.Components;
using ExpenseTracker.WebPortal.Components.Account;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies([
        typeof(ExpenseTracker.WebPortal.Client._Imports).Assembly,
        typeof(ExpenseTracker.Razor._Imports).Assembly]);
